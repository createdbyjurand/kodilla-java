...
public class NotacjaBigO {
  ...
  public static void main(String[] args) throws java.lang.Exception {
    ...
    display(
      "O(c) " + AnsiColor.RESET + "- złożoność stała, niezależna od ilości danych wejściowych", AnsiColor.GREEN);
    display(
      "O(log n) " + AnsiColor.RESET
        + "- złożoność logarytmiczna, spotykana na przykład przy przeszukiwaniu uporządkowanych drzew binarnych",
      AnsiColor.GREEN);
    display(
      "O(n) " + AnsiColor.RESET + "- złożoność liniowa", AnsiColor.GREEN);
    display(
      "O(n ^ 2) " + AnsiColor.RESET + "- złożoność kwadratowa", AnsiColor.GREEN);
    display(
      "O(c ^ n) " + AnsiColor.RESET + "- złożoność wykładnicza", AnsiColor.GREEN);
  }
}
