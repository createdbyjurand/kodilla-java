...
public class UzupelnieniePomiaryWKolekcjach {
  ...
  public static void main(String[] args) throws java.lang.Exception {
    ...
    display(
      "Added 1 element at the beginning of an " + (linkedList.size() - 1) + " element LinkedList in " + (end - begin)
        + "ms", AnsiColor.RED);
    ...
    display(
      "Added 1 element at the end of an " + (linkedList.size() - 1) + " element LinkedList in " + (end - begin)
        + "ms", AnsiColor.RED);
    ...
    display(
      "Removed 1 element from the beginning of an " + (linkedList.size() + 1) + " element LinkedList in " + (end
        - begin) + "ms", AnsiColor.RED);

    begin = System.currentTimeMillis();
    linkedList.remove(new Book("Title Last", "Author Last"));
    end = System.currentTimeMillis();
    display(
      "Removed 1 element from the end of an " + (linkedList.size() + 1) + " element LinkedList in " + (end
        - begin) + "ms", AnsiColor.RED);
